...
```bash
# 1. 克隆仓库
git clone https://github.com/YOUR_USERNAME/jingjigo-os.git
cd jingjigo-os
...
- **项目主页**: https://github.com/YOUR_USERNAME/jingjigo-os
- **问题反馈**: https://github.com/YOUR_USERNAME/jingjigo-os/issues
- **讨论区**: https://github.com/YOUR_USERNAME/jingjigo-os/discussions
